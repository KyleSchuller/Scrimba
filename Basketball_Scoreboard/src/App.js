...
const initializeElements = async () => {
  ...
  return new ScoreBoard(homeScoreElement, guestScoreElement, undoButton, redoButton, resetButton, historyListElement);
};

const addEventListeners = (scoreBoard) => {
...
const initializeModals = (appElement) => {
...
const init = async () => {
  try {
    const scoreBoard = await initializeElements();
    addEventListeners(scoreBoard);
